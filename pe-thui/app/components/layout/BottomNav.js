...
export default function BottomNav({ view, setView }) {
    ...
    return (
        <nav className="fixed bottom-0 w-full max-w-lg left-1/2 -translate-x-1/2 z-50 flex justify-around items-center px-4 py-[10px] backdrop-blur-2xl bg-white/80 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.05)] border-t border-white/20">
