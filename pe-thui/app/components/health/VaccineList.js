...
export default function VaccineList({ dob, records, code, onSave }) {
    ...
    const renderSummaryTable = () => (
        <div className="bg-surface-container-lowest rounded-[2rem] shadow-[0px_20px_40px_rgba(165,51,97,0.08)] overflow-hidden">
            <div ref={summaryBodyScrollRef} className="overflow-x-auto custom-scrollbar">
    ...
    return (
        <div className="space-y-10 pb-9">
            ...
            <section className="space-y-8">
                <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-md pb-4 pt-4 -mx-4 px-6 rounded-b-2xl border-b border-primary/10 shadow-sm flex justify-between items-center transition-all duration-300">
